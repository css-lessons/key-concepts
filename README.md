...
* Строчные элементы могут содержать только данные или другие строчные элементы. Блочные элементы в них вкладывать можно, но HTML код получится невалидным и это может привести к непредсказуемым последствиям
...
Такие элементы перенимают некоторые свойства блочных и строчных элементов. От
